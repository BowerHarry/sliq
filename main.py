...
class Border(RelativeLayout):
    ...
    def animateRotation(self, *kwargs):
                ...
                if (i == 0 and j==0) or (i == self.length-1 and j == 0) or (i == 0 and j == self.length-1) or (i == self.length-1 and j == self.length-1):
                    ...
                    if i == 0 or i == self.length-1:
                        ...
                        if i == self.length-1:
                            ...
                            x = i
                        self.add_widget(TileVerticalEdge(x=90+(x*100), y=(j*100), ids={'x': i, 'y': j, 'value':self.grid[i][j], 'object':'border'}, s=s))
                    if j == 0 or j == self.length-1:
                        ...
                        self.add_widget(TileHorizontalEdge(x=(i*100), y=90+(y*100), ids={'x': i, 'y': j, 'value':self.grid[i][j], 'object':'border'}, s=s))
